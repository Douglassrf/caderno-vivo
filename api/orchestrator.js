...
if(!resp.ok){
/* FIX: DB indisponivel — fallback para env var */
...
if(!rows.length){
/* FIX: tabela vazia — fallback para env var */
if(provider==='groq'&&GROQ_API_KEY)return{id:'env-groq',key:GROQ_API_KEY};
if(provider==='pollinations')return{id:'pollinations-free',key:'free'};
return null;
}
...
/* FIX: excecao — fallback para env var */
if(provider==='groq'&&GROQ_API_KEY)return{id:'env-groq',key:GROQ_API_KEY};
if(provider==='pollinations')return{id:'pollinations-free',key:'free'};
return null;
}
